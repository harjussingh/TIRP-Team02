...
class LanguageCard(AnimatedCard):
    def __init__(
        ...
        root.setContentsMargins(40, 38, 40, 32)
        root.setSpacing(0)
...
class HomePage(QWidget):
    ...
    def _build_language_screen(self):
        ...
        outer.setContentsMargins(72, 52, 72, 34)
        outer.setSpacing(0)
        ...
        self.choose_language_kriol_label.setAlignment(Qt.AlignLeft)
        ...
        self.english_card = LanguageCard(
            "EN", "English", "Speak in English", "Select", "languageBadgeEn", "languageActionBlue"
        )
        self.kriol_card = LanguageCard(
            "KR", "Kriol", "Tok langa Kriol", "Pikimup", "languageBadgeKr", "languageActionOchre"
        )
        ...
        self.emergency_btn.setFixedSize(440, 64)
        ...
        layout.addSpacing(42)
        layout.addWidget(self.emergency_btn, 0, Qt.AlignLeft)

        center_row.addWidget(content, 0, Qt.AlignTop | Qt.AlignHCenter)
        center_row.addStretch(1)
    ...
    def _build_mode_screen(self):
        ...
        self.subtitle_1.setAlignment(Qt.AlignCenter)
        ...
        self.speak_card = ModeCard("mic", "Speak", "Talk and we will listen", "speakIconBox")
        self.picture_card = ModeCard("picture", "Pictures", "Show us where it hurts", "pictureIconBox")
        self.type_card = ModeCard("type", "Type", "Write what you feel", "typeIconBox")
        ...
        emergency_row.addWidget(self.mode_emergency_btn)
        emergency_row.addStretch(1)
        ...
        layout.addWidget(self.speak_card, 0, Qt.AlignCenter)
        layout.addSpacing(20)
        layout.addWidget(self.picture_card, 0, Qt.AlignCenter)
        layout.addSpacing(20)
        layout.addWidget(self.type_card, 0, Qt.AlignCenter)
        layout.addSpacing(36)
    ...
    def set_strings(self, s: dict):
        ...
        self.title_label.setText("Yu fil wanem?" if is_kriol else "How are you feeling?")
        self.subtitle_1.setText("Telim mipala wetin rong." if is_kriol else "Tell us what is wrong.")
        self.subtitle_2.setText("Jusum isiwei fo yu." if is_kriol else "Choose the easiest way for you.")
        ...
        self.mode_emergency_btn.setText("ⓘ  Imijensi Elp" if is_kriol else "ⓘ  Emergency Help")
