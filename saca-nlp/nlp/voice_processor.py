...
class VoiceProcessor:
    ...
    def __init__(self, model_name: str = 'small'):
        ...
        # Short neutral hint — long prompts cause Whisper hallucinations
        self.medical_prompt = "Symptoms:"
        self.kriol_prompt = "Symptoms:"
        self.bilingual_prompt = "Symptoms:"
    ...
    def transcribe_audio(
        ...
        try:
            ...
            # Transcribe with Whisper — no initial_prompt to avoid hallucination
